		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#hogenthogent-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hogenthogent-display": {
								"semanticObject": "hogenthogent",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hogent.hogent",
									"url": sap.ui.require.toUrl("hogent/hogent")
								}
							}
						}
					}
